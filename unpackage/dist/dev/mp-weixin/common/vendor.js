...
function initRuntimeSocketService() {
  const hosts = "172.30.234.7,192.168.75.1,192.168.107.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_Ge_24w";
...
const b = true, k = "mp-weixin", E = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = k, P = T('{"address":["127.0.0.1","172.30.234.7","192.168.75.1","192.168.107.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","F:/迅雷下载/HBuilderX.4.87.2025121004/HBuilderX/plugins/unicloud/**/*.js"]}'), C = T('[{"provider":"aliyun","spaceName":"database-ali","spaceId":"mp-a509e61d-bd3a-4a4e-989b-822fffccb267","clientSecret":"7FJL6r8wV0pjQ++CPC4X/g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__B0480DC";
} catch (e2) {
...
(() => {
  ...
  if (Object.assign(er, { get mixinDatacom() {
    return Bs(er);
  } }), Ls(er), er.addInterceptor = q, er.removeInterceptor = F, er.interceptObject = B, "web" === A)
    ;
})();
