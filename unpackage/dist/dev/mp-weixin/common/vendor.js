...
function initRuntimeSocketService() {
  const hosts = "172.30.234.79,192.168.126.1,192.168.174.1,172.24.152.228,127.0.0.1";
  const port = "8091";
  const id = "mp-weixin_NUgrZr";
...
const b = true, k = "mp-weixin", E = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = k, P = T('{"address":["127.0.0.1","172.30.234.79","192.168.126.1","192.168.174.1","172.24.152.228"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX/plugins/unicloud/**/*.js"]}'), C = T('[{"provider":"aliyun","spaceName":"database-ali","spaceId":"mp-a509e61d-bd3a-4a4e-989b-822fffccb267","clientSecret":"7FJL6r8wV0pjQ++CPC4X/g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__A381AC9";
} catch (e2) {
